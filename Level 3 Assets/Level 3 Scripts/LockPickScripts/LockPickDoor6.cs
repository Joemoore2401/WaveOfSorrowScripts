...
public class LockPickDoor6 : MonoBehaviour
{
    ...
    public GameObject Key3Off;
    public GameObject KeyTrigger3Off;
    ...
    public void SAPlayer()
    {
        ...
        ChestOpening.SetTrigger("Chest3");
        DoorSound.SetActive(true);
        Cursor.visible = false;
        fps.GetComponent<FirstPersonController>().enabled = true;
        Key3Off.SetActive(false);
        KeyTrigger3Off.SetActive(false);
